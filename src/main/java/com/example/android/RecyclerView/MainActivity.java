...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WordListAdapter mAdapter = new WordListAdapter(this, null);
...
// Retrieve the data for that position
            AbstractSequentialList mWordList = null;
            String mCurrent = (String) mWordList.get(position);
